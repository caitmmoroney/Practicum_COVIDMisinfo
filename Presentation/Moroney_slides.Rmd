...
## 
![Twitter adds warning labels to tweets.](./twitter_misinfo_1.jpg)

##
![Twitter removes misleading content.](./twitter_misinfo_2.jpg)

## Dataset from Boukouvalas et al. (2020)
...
$$\mathrm{tweet} \begin{bmatrix} v_{i1} \\ \vdots \\ v_{ik} \end{bmatrix} = \frac {\mathrm{covid} \begin{bmatrix} e_{11} \\ \vdots \\ e_{1k} \end{bmatrix} + \mathrm{is} \begin{bmatrix} e_{21} \\ \vdots \\ e_{2k} \end{bmatrix} + \mathrm{fake} \begin{bmatrix} e_{31} \\ \vdots \\ e_{3k} \end{bmatrix} + \mathrm{news} \begin{bmatrix} e_{41} \\ \vdots \\ e_{4k} \end{bmatrix}} {4}$$
