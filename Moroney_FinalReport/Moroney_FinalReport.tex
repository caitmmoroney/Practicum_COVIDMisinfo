...
We will refer to this method as \(\mathrm{PMI_0}\). This, however,
...
Note that for our experiments we found \(\mathrm{PMI_0}\) to work
...
final ICA word embeddings were formed using \(\mathrm{PMI_0}\).
...
Goldberg 2014). We compared PPMI, SPPMI, \(\mathrm{PMI_0}\), and
\(\mathrm{SPMI_0}\). We found that unshifted \(\mathrm{PMI_0}\) produced
the best embeddings from our set of 560 tweets.
